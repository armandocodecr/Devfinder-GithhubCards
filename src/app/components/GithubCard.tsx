...
export function GithubCard() {
  ...
  return (
    <>
      <div
       ...
       ${
         githubProfile && !githubProfile.error
           ? " transition-transform duration-75 hover:shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]"
           : ""
       }
      ...
      {githubProfile && !githubProfile.error && (
        <div
          className="w-5/12 min-w-[800px] flex flex-end flex-col gap-3
            max-[800px]:min-w-[650px] max-[650px]:min-w-[350px] max-[400px]:min-w-[300px]"
        >
          <button className="download-btn" onClick={onDownloadCard}>
            Get your GithubCard
          </button>
        </div>
      )}
