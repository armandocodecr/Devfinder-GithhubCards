            ...
            >
                ...
                <div className="flex flex-col">
                    <div className="flex flex-row items-center gap-24 max-[650px]:gap-0 max-[650px]:flex-col max-[650px]:items-start max-[650px]:">
                        <div className="flex flex-col">
                            <h2 className="text-2xl font-mono max-[650px]:text-xl">{ name }</h2>
                            <p className="text-[#0175F7] font-light max-[650px]:text-sm" >{ `@${ login }` }</p>
                        </div>
                        <p className="font-mono text-slate-300 max-[650px]:text-sm">{ `Joinded ${ formatDate( created_at ) }` }</p>
                    </div>
                </div>

                <div className="w-[400px] max-[650px]:w-[290px] max-[650px]:text-xs max-[650px]:mt-5">
