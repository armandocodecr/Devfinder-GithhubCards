...
export function CardInformationProfile({
  avatar_url,
  name,
  login,
  bio,
  ...
  return (
    <>
      <section
        className="w-full h-auto grid grid-cols-[200px_minmax(300px,_1fr)] 
      ...
      >
        ...
        <div className="flex flex-col">
          <div className="flex flex-row items-center gap-24 max-[650px]:gap-0 max-[650px]:flex-col max-[650px]:items-start max-[650px]:">
            <div className="flex flex-col">
              <h2 className="text-2xl font-mono max-[650px]:text-xl max-[400px]:text-lg">
                {name}
              </h2>
              <p className="text-[#0175F7] font-light max-[650px]:text-sm max-[400px]:text-[13px]">{`@${login}`}</p>
            </div>
            <p className="font-mono text-slate-300 max-[650px]:text-sm max-[400px]:text-[12px]">{`Joined ${formatDate(
              created_at
            )}`}</p>
          </div>
        </div>
